...
//            NSURL *videoInputUrl = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"大王叫我来巡山" ofType:@"mp4"]];
            ...
            NSURL *audioInputUrl1 = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"ZJCache" ofType:@"mov"]];
            // 视频来源
            ...
            [videoAudioManager compositionVideoUrl:audioInputUrl1
                                    videoTimeRange:CMTimeRangeMake(kCMTimeZero, kCMTimeZero)
                                     mergeVideoUrl:videoInputUrl
        ...
        case 1:
        {
            ...
            // 视频来源
            NSURL *videoInputUrl = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"ZJCache" ofType:@"mov"]];
